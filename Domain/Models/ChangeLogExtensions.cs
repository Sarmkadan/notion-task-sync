...
/// <summary>
/// Extension methods for <see cref="ChangeLog"/> providing additional functionality for audit trail operations.
/// </summary>
public static class ChangeLogExtensions
{
    ...
    /// </summary>
    /// <param name="changeLog">The change log entry to format. Cannot be <see langword="null"/>.</param>
    ...
    /// </summary>
    /// <param name="changeLog">The change log entry to check. Cannot be <see langword="null"/>.</param>
    ...
    /// </summary>
    /// <param name="changeLog">The change log entry. Cannot be <see langword="null"/>.</param>
    /// <param name="maxLength">Maximum length of the resulting string. Must be positive.</param>
