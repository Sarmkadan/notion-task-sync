...
public static class NotionPageJsonExtensions
{
    ...
    /// <summary>
    /// Serializes the <see cref="NotionPage"/> instance to a JSON string.
    /// </summary>
    /// <param name="value">The Notion page instance to serialize.</param>
    /// <param name="indented">Whether to format the JSON with indentation for readability.</param>
    /// <returns>A JSON string representation of the Notion page.</returns>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="value"/> is <see langword="null"/>.</exception>
    public static string ToJson(this NotionPage value, bool indented = false)
    {
    ...
    public static NotionPage? FromJson(string json)
    {
        ...
        return JsonSerializer.Deserialize<NotionPage>(json, _jsonOptions);
    }
    ...
    public static bool TryFromJson(string json, out NotionPage? value)
    {
        ...
        try
        {
            value = JsonSerializer.Deserialize<NotionPage>(json, _jsonOptions);
            return true;
        }
        catch (JsonException)
        {
